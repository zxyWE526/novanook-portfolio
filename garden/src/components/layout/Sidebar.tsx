...
export default function Sidebar() {
  return (
    <motion.aside
      ...
      className="fixed left-0 top-0 w-[240px] h-screen bg-[#0A0A0F] border-r border-[rgba(255,255,255,0.06)] flex flex-col z-50"
    >
      {/* Brand */}
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 group ${
                isActive
                  ...
                  : 'text-text-secondary hover:text-text-primary hover:bg-bg-hover border-l-2 border-transparent hover:border-accent'
              }`
            }
          >
