  ...
  useEffect(() => {
    ...
    c.setOption({
      ...
      series: [{
        ...
        regionHeight: 1.5,
        shading: 'realistic',
        groundPlane: { show: true, color: '#f8fafc' },
        light: {
          main: { intensity: 2, shadow: true, shadowQuality: 'high', alpha: 45, beta: -30 },
          ambient: { intensity: 0.3 },
          ambientCubemap: { texture: 'data-uri', exposure: 1, diffuseIntensity: 0.3 },
        },
        postEffect: {
          enable: true,
        ...
        viewControl: {
          projection: 'perspective', distance: 100, alpha: 35, beta: 0,
          center: [104, 35, 0],
          autoRotate: true, autoRotateSpeed: 5, autoRotateAfterStill: 2,
        },
        label: {
